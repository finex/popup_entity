(function ($, Drupal, cookies, once) {
  Drupal.behaviors.popup_entity = {
    attach: function (context, settings) {
      ...
      $(once('popup-entity-loaded', 'body')).each(function () {
      ...
      function show_popups(popups){
        ...
        popups.each(function() {
          ...
          if(is_visible(popup_element)) {
            ...
            var popup_views_count = cookies.get(popup_id + "_popup_count") || 0;
      ...
      function update_cookie(popup_element){
        ...
        cookies.set(popup_id + "_popup_count", popup_views_count, {expires: date});
      }
